...
train_list = [p for p in os.listdir(os.path.join(seq_home, 'Data/VID/train'))]
seq_list = []
for num, cur_dir in enumerate(train_list):
    seq_list += [os.path.join(cur_dir, p) for p in os.listdir(os.path.join(seq_home, 'Data/VID/train', cur_dir))]
