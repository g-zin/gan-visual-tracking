...
if not os.environ.get('TRK_WD', None):
    os.environ['TRK_WD'] = '.'
...
SEQ_SRC = os.environ['TRK_WD'] + '/datasets/benchmark' + '/'

TRACKER_SRC = os.path.abspath('./trackers/') + '/'

RESULT_SRC = os.path.abspath('./results/{0}/') + '/' # '{0} : OPE, SRE, TRE'
