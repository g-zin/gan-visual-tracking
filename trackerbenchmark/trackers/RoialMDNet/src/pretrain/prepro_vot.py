...
seq_home = os.environ['TRK_WD'] + '/datasets/vot'
seqlist_path = os.environ['TRK_WD'] + '/datasets/list/vot-otb.txt'
...
for i, seq in enumerate(seq_list):
    ...
    assert len(img_list) == len(gt), "Lengths do not match! seq:{}, img_list:{}, gt:{}".format(seq, len(img_list), len(gt))
