...
from .modules.roi_align import RoIAlign, RoIAlignAda
...
feat = torch.randn(num_imgs, 16, feat_size, feat_size, requires_grad=True, device='cuda:0')
...
print(test2)
test2 = gradcheck(RoIAlignAda(3, spatial_scale, 2), inputs, atol=1e-3, eps=1e-3)
print(test2)
