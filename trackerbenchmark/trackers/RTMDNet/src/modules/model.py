...
from ..modules.roi_align.modules.roi_align import RoIAlignMax
...
class MDNet(nn.Module):
    def __init__(self, model_path=None, k=1, receptive_field=75.):
        ...
        # it is receptive field that a element of feat_map covers. feat_map is bottom layer of ROI_align_layer
